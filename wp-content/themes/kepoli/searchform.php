<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <label>
        ...
        <input type="search" class="search-field" placeholder="<?php echo esc_attr(kepoli_ui_text('Cauta articole, obiceiuri, semnale ale corpului...', 'Search health facts, habits, body signals...')); ?>" value="<?php echo esc_attr(get_search_query()); ?>" name="s">
    </label>
