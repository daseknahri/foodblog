...
<header class="site-header">
    <div class="site-header__inner">
        <a class="site-brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="<?php echo esc_attr(sprintf(kepoli_ui_text('Acasa %s', '%s home'), kepoli_site_name())); ?>">
            <img src="<?php echo esc_url(kepoli_asset_uri('kuchniatwist-wordmark')); ?>" alt="<?php echo esc_attr(kepoli_site_name()); ?>"<?php echo kepoli_asset_dimension_attributes('kuchniatwist-wordmark'); ?> decoding="async">
        </a>
