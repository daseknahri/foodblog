...
- Legal pages, homepage, and posts can be tracked because Histats is analytics, not an ad unit.

## How To Use It

Use Histats as the fast dashboard for:

- live visitors;
- pages per visit;
- referrers from Facebook;
- mobile/desktop split;
- top visited URLs.

Use UTM links in Facebook posts so Histats referrers and future GA4 reports stay readable.
